Sub 三つ以上の部分一致条件で絞込みを行う()
    ...
    'アクティブセルから下方向に検索し、一致しない行を非表示にします（オートフィルターを使いません）
    Dim V As Variant
    Dim i As Integer
    Dim x As Integer
    Dim y As Long
    ...
    If Not IsEmpty(V) Then
        ...
        For y = ActiveCell.Row To ActiveCell.CurrentRegion.Rows(ActiveCell.CurrentRegion.Rows.Count).Row
            i = 0
