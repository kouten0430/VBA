Sub 出退社記録交通事情()
    ...
    Set select2 = frame1.getElementById("ddlSJyRiyuCd1")    '除外理由
    ...
    If 出社時刻 <= #8:40:00 AM# And 出社時刻 >= #7:50:00 AM# Then
        出社実績 = #8:40:00 AM#
        出社予定 = #8:40:00 AM#
    ...
    If 退社時刻 <= #5:40:00 PM# And 退社時刻 >= #5:20:00 PM# Then
        退社実績 = #5:20:00 PM#
        退社予定 = #5:20:00 PM#
    ElseIf 退社時刻 > #9:05:00 PM# Then
        退社実績 = #9:00:00 PM#
        退社予定 = #9:00:00 PM#
    ElseIf 退社時刻 < #5:20:00 PM# Then
        退社予定 = 退社実績
    Else
