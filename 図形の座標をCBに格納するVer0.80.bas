Sub 図形の座標をCBに格納する()
    ...
    If Selection.ShapeRange.Count = 1 Then
        ...
        ElseIf tmp = "2" Then
            x = Selection.ShapeRange.Left + Selection.ShapeRange.Width / 2
            y = Selection.ShapeRange.Top
        ElseIf tmp = "3" Then
            x = Selection.ShapeRange.Left + Selection.ShapeRange.Width
            y = Selection.ShapeRange.Top
        ElseIf tmp = "4" Then
            x = Selection.ShapeRange.Left
            y = Selection.ShapeRange.Top + Selection.ShapeRange.Height / 2
        ElseIf tmp = "5" Then
            x = Selection.ShapeRange.Left + Selection.ShapeRange.Width
            y = Selection.ShapeRange.Top + Selection.ShapeRange.Height / 2
        ElseIf tmp = "6" Then
            x = Selection.ShapeRange.Left
            y = Selection.ShapeRange.Top + Selection.ShapeRange.Height
        ElseIf tmp = "7" Then
            x = Selection.ShapeRange.Left + Selection.ShapeRange.Width / 2
            y = Selection.ShapeRange.Top + Selection.ShapeRange.Height
        ElseIf tmp = "8" Then
